	...
	<div>
		...
		<el-card>
            ...
            <el-row :gutter="24" class="item-style">
                ...
                <el-col :span="18">
                    <div><img :src="shopDetail.shopLogo" class="shop-pic" /></div>
                </el-col>
            </el-row>
            <el-row :gutter="24" class="item-style">
            ...
            <el-row :gutter="24" class="item-style">
                ...
                <el-col :span="18"><div>{{shopDetail.shop_address}}</div></el-col>
            </el-row>
            <el-row :gutter="24" class="item-style">
           ...
           <!-- <el-row :gutter="24" class="item-style">
            ...
            <el-row :gutter="24" class="item-style">
                ...
                <el-col :span="18"><div>{{shopDetail.star}}</div></el-col>
            </el-row>
			<!-- <el-row :gutter="24" class="item-style">
			    <el-col :span="3" :offset="1"><div>支付方式</div></el-col>
			    <el-col :span="18"><div>{{shopDetail.money_type}}</div></el-col>
			</el-row> -->
		</el-card>
	</div>
</template>
