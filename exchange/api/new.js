...
// 购买
export function buy(data, callback) {
  request.postAuth("home/Index/buy", data, res => {
    callback && callback(res);
  });
}
// 出售
export function sell(data, callback) {
  request.postAuth("home/Index/sell", data, res => {
    callback && callback(res);
  });
}

// 上传打款凭证
export function seeProof(data, callback) {
  request.postAuth("home/Index/seeProof", data, res => {
    callback && callback(res);
  });
}

// 查看打款凭证
export function uploadProof(data, callback) {
  request.postAuth("home/Index/uploadProof", data, res => {
    callback && callback(res);
  });
}

// 确认收款
export function confirmReceipt(data, callback) {
  request.postAuth("home/Index/confirmReceipt", data, res => {
    callback && callback(res);
  });
}
// 取消订单
export function cancelOrder(data, callback) {
  request.postAuth("home/Index/cancelOrder", data, res => {
    callback && callback(res);
  });
}
// 大盘行情
export function hangqing(data, callback) {
  request.postAuth("home/Index/hangqing", data, res => {
    callback && callback(res);
  });
}
// 外盘我的
export function waipanSelf(data, callback) {
  request.postAuth("home/Index/waipanSelf", data, res => {
    callback && callback(res);
  });
}
// 划转回APp
export function huazhuanhuiApp(data, callback) {
  request.postAuth("home/Index/huazhuanhuiApp", data, res => {
    callback && callback(res);
  });
}
