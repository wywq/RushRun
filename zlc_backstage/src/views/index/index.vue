  ...
  <div>
    ...
    <el-row :gutter="20" style="margin-bottom: 20px;">
      ...
      <el-col :span="12">
        <el-card>
          <h3 class="mid_title">
            <i class="el-icon-date" style="color: blue;margin-right: 10px;"></i
            >销售情况统计
          </h3>
          <div class="mid_fenge"></div>
          <div class="xiaoliang">
            <div class="xiao_item">
              ...
              <div class="xiao_contnet">
                订单量(件)：{{ midright.order_yesterday }}
              </div>
              <div class="xiao_contnet">
                订单金额(元)：{{ midright.price_yesterday }}
              </div>
            </div>
            <div class="xiao_item">
              <div class="xiao_title">昨日销量</div>
              <div class="xiao_contnet">
                订单量(件)：{{ midright.order_month }}
              </div>
              <div class="xiao_contnet">
                订单金额(元)：{{ midright.price_month }}
              </div>
            </div>
          </div>
        </el-card>
    ...
    <el-row :gutter="20" style="margin-bottom: 20px;">
      <el-col :span="4">
        <el-card class="food_item">
          ...
          <div class="food_status">未支付订单</div>
    ...
    <el-card>
      <h3 class="mid_title">
        <i class="el-icon-date" style="color: green;margin-right: 10px;"></i
        >订单总数统计
      </h3>
      <div class="mid_fenge"></div>
      <el-tabs
