      ...
      <view class="content_view" v-show="isShow">
        <view class="title_view">
          ...
          <view class="close_view" @click="hidden">
            ...
            <image class="close_icon" src="/static/img/close.png"></image>
          </view>
        </view>
        <view class="select_top">
          <view
            class="select_top_item"
            ref="select_top_item"
        ...
        <swiper class="swiper" :current="currentIndex" @change="swiperChange">
          <swiper-item
            v-for="(swiper_item, swiper_index) in dataList"
            :key="swiper_index"
          >
            <view class="swiper-item">
              <scroll-view class="scroll-view-item" scroll-y="true">
                ...
                >
                  <image
                    v-if="selectIndexArr[swiper_index] === index"
    ...
    hidden() {
      ...
      setTimeout(() => {
        if (
          ...
          // this.cityAreaArray = [],
          // this.selectIndexArr = [],
          // this.address_item_click(swiper_index, index)
        }
      }, 500);
    },
