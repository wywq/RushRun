    ...
    data () {
      return {
		...
		created(){
			...
			this.$store.getters.addRouters.forEach((item,index)=>{
				item.nav_id = index
				console.log(item)
			})
			console.log(this.$store.getters.addRouters,this.$store.getters.tabnavBox)
		},
    methods: {
